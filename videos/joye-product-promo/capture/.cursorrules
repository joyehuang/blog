# Home • Joye Personal Blog

Source: http://127.0.0.1:4321/en
...
| `extracted/tokens.json` | Design tokens: 20 colors, 2 fonts, 20 headings, 10 CTAs |
...
| `assets/svgs/contact-sheet.jpg` | SVGs rendered as thumbnails in labeled grid — page 1 of 3 |
| `assets/svgs/contact-sheet-1.jpg` | SVGs rendered as thumbnails in labeled grid — page 2 of 3 |
| `assets/svgs/contact-sheet-2.jpg` | SVGs rendered as thumbnails in labeled grid — page 3 of 3 |
| `assets/` | Individual downloaded images, SVGs, and font files. |

## Brand Summary

- **Colors**: #FAFAFA (bg-light), #0B0B10 (surface-dark), #313135 (surface-dark), #1D1D20 (surface-dark), #BCBCC2 (surface-light), #FFFFFF (bg-light), #F8F8F8 (bg-light), #000000 (bg-dark), #09090B (bg-dark), #4ADE80 (surface-light)
- **Fonts**: JetBrains Mono (400,500,600), Satoshi (400,500,600,700)
