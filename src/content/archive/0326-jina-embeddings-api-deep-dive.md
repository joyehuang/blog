...
这张卡片现在已经不只是 Jina 官方信息摘录，而是一个更接近真实选型场景的整理：

- 一部分来自我实际阅读的 Jina 官方产品页与 v4 / v5 release note
- 一部分来自 Grok 分享里对 **Jina vs Qwen3-Embedding** 的横向比较

所以这篇更适合当成：

> **Jina Embeddings 的能力梳理 + 与 Qwen3 的选型对照面板**

如果只看一句话结论：

- **Jina** 更像“长文档 / 多模态 / 生产部署友好”的 embedding 基础设施
- **Qwen3-Embedding** 更像“中文 / 多语言高精度优先”的 embedding 方案
- 真正实用的系统设计，往往是 **Jina recall + Qwen rerank**

## 快速结论

| 问题 | 最短答案 |
| --- | --- |
| Jina 值不值得看 | 值得，尤其是长文档、多模态、生产落地场景 |
| Jina v4 和 v5 怎么分 | `v4 = 多模态 / visually rich retrieval`，`v5 = 文本检索 / production-oriented` |
| Jina 和 Qwen3 怎么选 | 中文高精度偏 Qwen3，长文档与部署性价比偏 Jina |
| 最实用的组合 | `Jina recall + Qwen rerank` |

## 选型总览

### Jina vs Qwen3-Embedding
...
这部分原本是从 Grok 分享补进来的横向对比，现在保留它，主要是为了补足“官方材料之外，真实选型时怎么看”的视角。
