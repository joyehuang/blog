...
{/* ![图1: 梯度消失曲线图 - 标准差随层数递减](placeholder_gradient_vanishing.png) */}
...
{/* ![图2: RMSNorm 效果对比 - 有无归一化的标准差变化](placeholder_rmsnorm_effect.png) */}
...
{/* ![图3: LayerNorm vs RMSNorm 速度对比](placeholder_speed_comparison.png) */}
...
{/* ![图4: Transformer Block 结构图 - 标注 RMSNorm 位置](placeholder_transformer_block.png) */}
...
{/* ![图5: Pre-Norm vs Post-Norm 对比](placeholder_prenorm_postnorm.png) */}
