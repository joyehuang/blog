---
title: 'Inside OpenHarness: A One-Day Code Walkthrough'
description: 'My one-day study notes on OpenHarness, a Claude Code-inspired Agent Harness in Python. Covering CLI launch to the Agent Loop.'
